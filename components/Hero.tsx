    ...
    <section className="mx-auto grid min-h-[calc(100vh-81px)] max-w-7xl items-center gap-16 px-6 py-20 lg:grid-cols-2">
      <div>
        ...
        {isAuthenticated ? (
          ...
          <h1 className="text-4xl font-extrabold leading-[1.15] tracking-tight md:text-5xl lg:text-6xl xl:text-[4.25rem]">
            The{" "}
            <span className="text-cyan-400">cheapest AI coach</span> out there,
            plus the only one that connects to{" "}
            <span className="text-cyan-400">TradingView</span>, also the only
            one that has{" "}
            <span className="text-cyan-400">LIVE talks</span> with coach AI.
          </h1>
        )}
